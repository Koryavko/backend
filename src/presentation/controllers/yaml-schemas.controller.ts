...
import { GetProductParseRuleRequest } from '../requests/yaml-schemas/get-product-parse-rule.request';
...
export class YamlSchemasController {
  ...
  public async getYamlSchemas(@Query() query: GetProductParseRuleRequest): Promise<GetProductParseRulesResponse> {
